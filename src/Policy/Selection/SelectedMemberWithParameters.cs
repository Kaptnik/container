...
namespace Unity.Policy.Selection
{
    ...
    /// </summary>
    public class SelectedMemberWithParameters<TContext> 
        where TContext : IBuildContext
    {
        private readonly List<ResolveDelegate<TContext>> _parameterResolvers = new List<ResolveDelegate<TContext>>();
        ...
        public void AddParameterResolver(ResolveDelegate<TContext> newResolver)
        {
        ...
        public ResolveDelegate<TContext>[] GetParameterResolvers()
        {
    ...
    /// </summary>
    public class SelectedMemberWithParameters<TContext, TMemberInfoType> : SelectedMemberWithParameters<TContext>
        where TContext : IBuildContext
    {
        /// <summary>
